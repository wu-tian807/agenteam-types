/**
 * @desc Slash-command parser — shared between the engine (stdin command routing)
 *       and channels (ink-renderer slash commands). Zero engine dependency, pure
 *       string parsing, so it lives in @agenteam/types alongside the protocol.
 */
